...
//     }
	...
	if(count($temp_ekor) < 15){
    	...
    	return view('index.cambodia', compact('cambodia','cmbodia','sorted','users','cmb_number','cmb_as','cmb_kop','cmb_kepala','cmb_ekor','cmb','gg','majoritas_as','majoritas_kop','majoritas_kepala','majoritas_ekor','val_as','gg_as','gg_kop','gg_kepala','gg_ekor','tes_as','js_tes','arr_as','arr_kop','arr_kepala','arr_ekor'));
    }
...
//     }
	...
	if(count($temp_ekor) < 15){
    	...
    	return view('index.cambodia', compact('cambodia','taiwn','sorted','users','twn_number','twn_as','twn_kop','twn_kepala','twn_ekor','twn','gg','majoritas_as','majoritas_kop','majoritas_kepala','majoritas_ekor','val_as','gg_as','gg_kop','gg_kepala','gg_ekor','tes_as','js_tes','arr_as','arr_kop','arr_kepala','arr_ekor'));
    }
