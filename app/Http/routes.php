...
Route::get('/analisissingapura-m', 'IndexController@showanalisissingapuram');
Route::get('/analisissydney', 'IndexController@showanalisissydney');
Route::get('/analisissydney-m', 'IndexController@showanalisissydneym');
...
Route::get('/analisistaiwan-m', 'IndexController@showanalisistaiwanm');
Route::get('/analisischina', 'IndexController@showanalisischina');
Route::get('/analisischina-m', 'IndexController@showanalisischinam');
Route::get('/analisishongkong', 'IndexController@showanalisishongkong');
Route::get('/analisishongkong-m', 'IndexController@showanalisishongkongm');
