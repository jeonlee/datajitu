          ...
          <div id="sidebarleft">
              <nav>
                <ul id="sidemenu" class="sidemenu">
                  ...
                  <li><a class="nav-results" title="Jadwal Keluaran" href="{{ url('/prediksisgp') }}">Prediksi Togel<div class="comingsoon" style="width:70px;"><img style="float:left; width:50%;" src="images/coming-soon.png"></div></a></li>
