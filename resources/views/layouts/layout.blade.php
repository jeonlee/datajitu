      ...
      <div class="row">
        <div class="col-sm-3 col-md-2 sidebar">
          <ul class="nav nav-sidebar">
            <li class="active"><a href="#">Hasil Keluaran <span class="sr-only">(current)</span></a></li>
            ...
            <li><a href="#" data-toggle="collapse" data-target="#reports" aria-expanded="false" aria-controls="reports">List Reports <span class="pull-right"><i class="fa fa-caret-down" aria-hidden="true"></i></span></a></li>
              ...
              <div class="collapse" id="prediksis">
                <ol>
                  <li><a href="{{ url('/admin/prediksisgp') }}">Togel Singapore</a></li>
                  <li><a href="{{ url('/admin/prediksisyd') }}">Togel Sydney</a></li>
                  <li><a href="{{ url('/admin/prediksicmb') }}">Togel Cambodia</a></li>
