...
@section('content')
              ...
              <div class="panel panel-primary">
                ...
                <?php
                    ...
                    $as=array_count_values($syd_as);
                    $kop=array_count_values($syd_kop);
                    $kepala=array_count_values($syd_kepala);
                    $ekor=array_count_values($syd_ekor);
	    ...
	    <a class="button-blue" title="Lottery Results - Lotto" href="{{ url('/hasilsydney') }}">Hasil Lengkap</a>
              ...
              <div class="frequency-cointainer">
				...
				<h1>Statistik Keluaran Sydney [30 Undian]</h1>
