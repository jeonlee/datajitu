...
<div class="panel panel-primary">
  <div class="panel-heading p15 black font">
    <div class="panel-title">
      <h3>LIVE DRAW TOGEL HONGKONG</h3>
    </div>
  </div>
  <div class="panel-body hidden-sm hidden-xs">
    <div style="width:677px; height:500px; left:70px; overflow:hidden;position:relative; margin-bottom:10px; float:left;">
            <iframe scrolling="no" src="http://www.hongkongpools.com/" style="border: 0px none; margin-left: -276px; margin-top: -150px; width: 960px; height: 555px;"></iframe>
        </div>
