...
@section('content')
              ...
              <div class="panel panel-primary">
                <div class="panel-heading p15 black font">
                  <div class="panel-title">
                    <h3>Hasil Keluaran Togel Japan</h3>
                  </div>
                </div>

                <div class="panel-body">
                @foreach ($sorted->slice(0, 1) as $japan)
                <?php
                    ...
                    $as=array_count_values($jpn_as);
                    $kop=array_count_values($jpn_kop);
                    $kepala=array_count_values($jpn_kepala);
                    $ekor=array_count_values($jpn_ekor);
              ...
              <div class="resultBox shorter centred hidden-sm hidden-xs">
                <div class="sideHeader tokyoball">
                  ...
                  <div class="col-xs-7">
                    ...
                    <h3 style="color: #FFF;"><span class="smallerHeading">Hasil Keluaran </span><br>{{ $japan->hari }} <br><span class="smallerHeading">{{ Carbon\Carbon::parse($japan->tanggal)->format('d-m-Y') }}</span></h3>
                  </div>
                </div><!-- sideheader -->
        ...
        <a class="button-grey" title="Lottery Results - Lotto" href="{{ url('/prediksijpn') }}">Prediksi Selanjutnya</a>
        </div>
        <div class="col-xs-6 text-center">
        ...
        <h1>Statistik Keluaran Japan [30 Undian]</h1>
    ...
    <div class="table">
      <table class="middle">
        ...
        <tbody>
        @foreach ($nippon as $jpnr)

          <tr>
        <td><div class="t_no f20">{{ Carbon\Carbon::parse($jpnr->tanggal)->format('d-m-Y') }}</div></td>
        <td><div class="t_hari f20">{{ $jpnr->periode }}-JPN</div></td>

        <td><div class="t_tgl biru f20"><a class="blue-number" href="/analisis/{{ $jpnr->id }}">{{ $jpnr->number }}</a></div></td>   
