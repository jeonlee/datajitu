...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
		<div style="width:310px; height:373px; left:60px; overflow:hidden;position:relative; margin-bottom:10px; float:left;">
          	<iframe scrolling="no" src="http://livesgp.net/4d" style="border: 0px none; margin-left: -41px; margin-top: -401px; width: 355px; height: 778px;"></iframe>
        </div>
        <div style="width:310px; height:373px; right:60px; overflow:hidden;position:relative; margin-bottom:10px; float:right;">
          <iframe scrolling="no" src="http://livesgp.net/4d" style="border: 0px none; margin-top: -401px; width: 707px; height: 737px; margin-left: -392px;"></iframe>
        </div>
    </div>
</div>
