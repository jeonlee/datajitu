      ...
      <div class="form-group" style="overflow:hidden; margin-bottom:0px;">
        <div class="col-xs-12 col-md-6">
          ...
          <div style="overflow:hidden;" class="form-group">
            <input type="date" name="startDate" id="from1" class="form-control input-sm" onfocus="(this.type='date')"  placeholder="dd-mm-yyyy">
        </div>
        </div>
        <div class="col-xs-12 col-md-6">
          Sampai :
          <div style="overflow:hidden;" class="form-group">
            <input type="date" class="input-sm form-control" name="endDate" onfocus="(this.type='date')" id="to1" placeholder="dd-mm-yyyy">
        </div>
      </div> 
      </div>
