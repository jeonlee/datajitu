...
@section('content')
              ...
              <div class="panel panel-primary">
                ...
                <?php
                    ...
                    $as=array_count_values($chn_as);
                    $kop=array_count_values($chn_kop);
                    $kepala=array_count_values($chn_kepala);
                    $ekor=array_count_values($chn_ekor);
    ...
    <h1>Statistik Keluaran China [30 Undian]</h1>
