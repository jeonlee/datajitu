      ...
      <div class="col-xs-12">
        <div class="tab-content">
          <div class="tab-pane active" id="4d">
            <h5 style="font-weight:bold;">Analisis Data 4D Japan</h5>
        ...
        <div class="tab-pane" id="besarkecilas">
          <h5 style="font-weight:bold;">Analisis Data Besar Kecil As Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="besarkecilkop">
          <h5 style="font-weight:bold;">Analisis Data Besar Kecil Kop Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="besarkecilkepala">
          <h5 style="font-weight:bold;">Analisis Data Besar Kecil Kepala Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="besarkecilekor">
          <h5 style="font-weight:bold;">Analisis Data Besar Kecil Ekor Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="colokjituas">
          <h5 style="font-weight:bold;">Analisis Data Colok Jitu As Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="colokjitukop">
          <h5 style="font-weight:bold;">Analisis Data Colok Jitu Kop Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="colokjitukepala">
          <h5 style="font-weight:bold;">Analisis Data Colok Jitu Kepala Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="colokjituekor">
          <h5 style="font-weight:bold;">Analisis Data Colok Jitu Ekor Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="dasarbesarkecil">
          <h5 style="font-weight:bold;">Analisis Data Dasar Besar Kecil Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="dasarganjilgenap">
          <h5 style="font-weight:bold;">Analisis Data Dasar Ganjil Genap Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="ganjilgenapas">
          <h5 style="font-weight:bold;">Analisis Data Ganjil Genap As Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="ganjilgenapkop">
          <h5 style="font-weight:bold;">Analisis Data Ganjil Genap Kop Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="ganjilgenapkepala">
          <h5 style="font-weight:bold;">Analisis Data Ganjil Genap Kepala Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="ganjilgenapekor">
          <h5 style="font-weight:bold;">Analisis Data Ganjil Genap Ekor Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="kembangkempisdepan">
          <h5 style="font-weight:bold;">Analisis Data Kembang Kempis Depan Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="kembangkempistengah">
          <h5 style="font-weight:bold;">Analisis Data Kembang Kempis Tengah Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="kembangkempisbelakang">
          <h5 style="font-weight:bold;">Analisis Data Kembang Kempis Belakang Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="shio">
          <h5 style="font-weight:bold;">Analisis Data Shio Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="silanghomodepan">
          <h5 style="font-weight:bold;">Analisis Data Silang Homo Depan Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
                ...
                @foreach ($japans as $japan)
                 <?php
                    ...
                    $tiga = substr("$japan->number",2,1);
                    $empat = substr("$japan->number",3,1);
                    $satush = substr("$japan->number",0,1) % 2;
                    $sh = 0;
                        if ($satush == $sh) {
                            $satush1 = "genap";
                        } else {
                    ...
                    $duash = substr("$japan->number",1,1) % 2;
                    $hs = 0;
                        if ($duash == $hs) {
                            $duash1 = "genap";
                        } else {
        ...
        <div class="tab-pane" id="silanghomotengah">
          <h5 style="font-weight:bold;">Analisis Data Silang Homo Tengah Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="silanghomobelakang">
          <h5 style="font-weight:bold;">Analisis Data Silang Homo Belakang Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
        ...
        <div class="tab-pane" id="tengahtepi">
          <h5 style="font-weight:bold;">Analisis Data Tengah Tepi Japan</h5>
          <div class="table-responsive">
            <table class="table table-hover table-bordered">
                <thead>
                    <tr>
