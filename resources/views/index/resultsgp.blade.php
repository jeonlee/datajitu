...
<div class="panel panel-primary">
  ...
  <div class="panel-body">
		<div style="width:310px; height:373px; left:60px; overflow:hidden;position:relative; margin-bottom:10px; float:left;">
          	<iframe scrolling="no" src="http://www.singaporepools.com.sg/en/product/Pages/toto_results.aspx" style="border: 0px none; margin-left: -41px; margin-top: -401px; width: 355px; height: 778px;"></iframe>
        </div>
