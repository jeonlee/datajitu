         ...
         <table align="center" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse;">
            <tbody>
               ...
               <tr style="background: white;">
                  <td align="center"><input class="isi" id="s1" maxlength="2" name="s1" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="1" type="text" /></td>
                  <td align="center"><input class="isi" id="s2" maxlength="2" name="s2" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="2" type="text" /></td>
                  <td align="center"><input class="isi" id="s3" maxlength="2" name="s3" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="3" type="text" /></td>
                  <td align="center"><input class="isi" id="s4" maxlength="2" name="s4" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="4" type="text" /></td>
                  <td align="center"><input class="isi" id="s5" maxlength="2" name="s5" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="5" type="text" /></td>
                  <td align="center"><input class="isi" id="s6" maxlength="2" name="s6" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver; font-size:1rem;" tabindex="6" type="text" /></td>
               </tr>
               <tr>
