...
<span style="color: #ff2600; font-size: large;">
  <b>Konversi Toto Singapore ke 4D </b></span></center><hr>
<br />
<table align="center" border="1" cellpadding="3" cellspacing="0" style="border-collapse: collapse; height: 10%px; width: 400pxpx;">
<tbody>
<tr><td align="center" colspan="6" style="background-color: #ac0031; border: solid #ac0031 .5pt; color: white; font-weight: bold;">Winning Numbers</td></tr>
<tr style="background: white;">
<td align="center"><input class="isi" id="s1" maxlength="2" name="s1" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="1" type="text" />
</td>
<td align="center"><input class="isi" id="s2" maxlength="2" name="s2" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="2" type="text" />
</td>
<td align="center"><input class="isi" id="s3" maxlength="2" name="s3" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="3" type="text" />
</td>
<td align="center"><input class="isi" id="s4" maxlength="2" name="s4" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="4" type="text" />
</td>
<td align="center"><input class="isi" id="s5" maxlength="2" name="s5" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="5" type="text" />
</td>
<td align="center"><input class="isi" id="s6" maxlength="2" name="s6" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="6" type="text" />
</td></tr>
<tr><td align="center" colspan="6" style="background-color: #ac0031; border: solid #ac0031 .5pt; color: white; font-weight: bold;" width="400px">Additional&nbsp; Number</td></tr>
<tr style="background: white;"><td align="center" colspan="6"><input class="isi" id="s7" maxlength="2" name="s7" onkeypress="huruf(this,event);" size="2" style="border: 1px solid silver;" tabindex="7" type="text" />
</td></tr>
<tr style="background: white;"><td align="center" colspan="6"><input id="hapus" name="hapus" onclick="hapusx()" tabindex="8" type="button" value="Hapus" />&nbsp;&nbsp;&nbsp;&nbsp;<input id="conv" name="conv" onclick="convert()" tabindex="8" type="button" value="Convert!" /></td></tr>
</tbody></table>
</div>
...
<tbody>
<tr><td colspan="6"><table align="center" border="0" cellpadding="0" cellspacing="0">
<tbody>
<tr height="15"><td colspan="4" style="font-size: 13pt;"><b>Hasil Konversi</b></td></tr>
<tr><td colspan="4" height="9"></td></tr>
<tr style="font-weight: bolder;">
<td class="td1" id="ab1" name="ab1">1</td><td class="td1" id="ab2" name="ab2">2</td><td class="td1" id="ab3" name="ab3">3</td><td class="td1" id="ab4" name="ab4">4</td>
</tr>
</tbody></table>
</td></tr>
</tbody></table>
