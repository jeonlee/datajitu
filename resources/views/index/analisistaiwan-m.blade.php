...
@section('content1')
  <div class="panel panel-primary">
                ...
                <form method="POST" action="/searchResultTaiwan-m">
    {{ csrf_field() }}
      <div class="form-group" style="overflow:hidden; margin-bottom:0px;">
        <div class="col-xs-12 col-md-6">
          Dari :
          <div style="overflow:hidden;" class="form-group">
            <input type="date" name="startDate" id="from1" class="form-control input-sm" placeholder="dd-mm-yyyy">
        </div>
        </div>
        <div class="col-xs-12 col-md-6">
          Sampai :
          <div style="overflow:hidden;" class="form-group">
            <input type="date" class="input-sm form-control" name="endDate" id="to1" placeholder="dd-mm-yyyy">
        </div>
      </div> 
      </div>
